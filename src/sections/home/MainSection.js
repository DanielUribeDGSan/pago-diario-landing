                ...
                <div className="row">
                    <div className="col-lg-6 d-flex align-items-center justify-content-center">
                        <div>
                            ...
                            <a className="buttons__bt buttons__btn-primary mr-3"> <FontAwesomeIcon className="mr-3 main-section__icon" icon={['fab', 'apple']} /> APP STORE</a>
                            <a className="buttons__bt buttons__btn-primary"> <FontAwesomeIcon className="mr-3 main-section__icon" icon={['fab', 'google-play']} /> GOOGLE PLAY</a>
                        </div>
                    </div>
                    <div className="col-lg-6 d-flex align-items-center justify-content-center">
                        <img
